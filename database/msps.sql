...
(1, 0, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2022, 0, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2022, 'bangladesh', ''),
(2, 11, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2022, 11, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2022, 'bangladesh', ''),
(3, 98, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2020, 98, '', 'ramvorda', 'hargila bajar', 'islampur', 'jamalpur', 2020, 'bangladesh', ''),
(4, 7, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2024, 7, '', 'Gopinathpur', 'Sontia Bazar', 'jamalpur sadar', 'jamalpur', 2024, 'bangladesh', 'abce defgh ijklm opqr stdu ');
...
(1, 'Romio ', 'asaduzzaman.romio@gmail.com', 1982541344, 'I want to admit my son to your school					\r\n					');
...
(4, 'Solaikan', 234789156, 1926547732, 'islam', 897652562, 1958321146);
...
(5, '2020-10-13', 'five', 'arts', 'day', 'sumaiya jannat ', 'female', 11, '2009-02-17', 1123478954, 1798541347);
...
(1, '\r\nromjan\r\n', 'physical teacher', 1779856312, 'romjan@msps.edu.bd'),
(2, 'Aktar\r\n', 'Moulovi', 1623148897, 'akram@ulia.edu.bd'),

(4, 'Md Jahangir Alam\r\n', 'Head Master', 1982541344, 'jahangir@msps.edu.bd'),
(5, 'Motiur Rahman\r\n\r\n', 'Assistant teacher', 1798321678, 'moti@ulia.edu.bd'),
